...
import { createAuthorizedQuery, createAuthorizedMutation, createAuthorizedAction } from "./lib/server";


const authenticatedQuery = createAuthorizedQuery(
  ["any"],
  [],
  true
)

const unauthenticatedQuery = createAuthorizedQuery(
  ["any"],
  [],
  false
)

const adminQuery = createAuthorizedQuery(
  ["admin"],
)

const brokerQuery = createAuthorizedQuery(
  ["broker"],
)
...
const authenticatedMutation = createAuthorizedMutation(
  ["any"],
  [],
  true
)

const unauthenticatedMutation = createAuthorizedMutation(
  ["any"],
  [],
  false
)

const adminMutation = createAuthorizedMutation(
  ["admin"],
)

const brokerMutation = createAuthorizedMutation(
  ["broker"],
)

const investorMutation = createAuthorizedMutation(
  ["investor"],
)
...
const authenticatedAction = createAuthorizedAction(
  ["any"],
  [],
  true
)

const unauthenticatedAction = createAuthorizedAction(
  ["any"],
  [],
  false
)
...
const adminAction = createAuthorizedAction(
  ["admin"],
)
const brokerAction = createAuthorizedAction(
  ["broker"],
)

const investorAction = createAuthorizedAction(
  ["investor"],
)
