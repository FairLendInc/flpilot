...
type RoleKey = "unauthenticated" | "member" | "investor" | "lawyer" | "broker" | "admin";
type OperationKind = "query" | "mutation" | "action";

const identitiesByRole: Record<RoleKey, { subject: string; role?: string } | undefined> = {
