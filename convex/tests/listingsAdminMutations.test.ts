...
describe("updateListing - Admin Authorization", () => {
	...
	test("should unlock listing with admin role", async () => {
		...
		// Unlock the listing
		await t.mutation(api.listings.updateListing, {
			listingId,
			locked: false,
		});
...
describe("deleteListing - Admin Authorization and Cascade", () => {
	test("should delete listing with admin role", async () => {
		...
		// Delete listing
		const result = await t.mutation(api.listings.deleteListing, {
			listingId,
		});
	...
	test("should cascade delete comparables when deleting listing", async () => {
		...
		// Delete listing
		await t.mutation(api.listings.deleteListing, {
			listingId,
		});
