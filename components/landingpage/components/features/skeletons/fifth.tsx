...
export const SkeletonFive = () => (
	<div className="relative flex h-full items-start justify-center overflow-hidden p-8">
		<div className="group-hover:-translate-y-80 absolute inset-0 flex flex-col items-center justify-center transition duration-200">
			<Container>
				<Image
					alt="avatar"
			...
			<p className="mt-4 font-bold text-neutral-400 text-sm">Manu Arora</p>
		...
		<div className="absolute inset-0 flex translate-y-80 flex-col items-center justify-center transition duration-200 group-hover:translate-y-0">
			...
			<p className="mt-4 font-bold text-neutral-400 text-sm">Tyler Durden</p>
			<div className="mt-4 flex items-center gap-2 text-xs">
				<p>Most engagements</p>
				<div className="h-1 w-1 rounded-full bg-neutral-400" />
				<p>8008</p>
...
const Container = ({
	...
	<div
		className={cn(
			"flex h-20 w-20 items-center justify-center rounded-lg bg-[rgba(248,248,248,0.01)] shadow-[0px_0px_8px_0px_rgba(248,248,248,0.25)_inset,0px_32px_24px_-16px_rgba(0,0,0,0.40)]",
			className
		)}
	>
		{children}
