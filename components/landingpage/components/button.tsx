...
export const Button: React.FC<{
	...
	return (
		<Tag
			className={cn(
				"group hover:-translate-y-0.5 relative z-10 flex items-center justify-center rounded-md bg-secondary px-4 py-2 font-medium text-black text-sm transition duration-200 hover:bg-secondary/90 active:scale-[0.98] md:text-sm",
				variantClass,
				className
			)}
			{...props}
