...
import { Eye, EyeOff, Lock, Unlock, Trash2, Edit } from "lucide-react";

export interface ListingWithMortgage {
	listing: {
		_id: Id<"listings">;
...
interface ListingManagementTableProps {
	...
	onEdit: (listingId: Id<"listings">, visible: boolean, locked: boolean) => void;
	onDelete: (listingId: Id<"listings">, address: string, locked: boolean) => void;
}
				...
				{listings.map(({ listing, mortgage }) => (
					<TableRow key={listing._id}>
						...
						<TableCell>
							<Badge
								variant={
									mortgage.status === "active" ? "default" : "secondary"
								}
							>
								{mortgage.status}
							</Badge>
