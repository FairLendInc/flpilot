...
- [x] 1.1 Add Mapbox token to environment variables
...
- [x] 1.2 Verify dependencies are installed
...
- [x] 1.3 Create component directory structure
...
- [x] 2.1 Define listings table in Convex schema
...
- [x] 2.4 Add sample seed data (for development)
...
- [x] 3.1 Create listing detail page route
...
- [x] 3.3 Create page layout structure
  - Implement responsive grid layout
  - Add Suspense boundaries for loading states
  - Create loading skeleton components

- [x] 3.4 Update listing card component
...
- [x] 4.1 Create base carousel component
...
- [x] 5.5 Implement responsive behavior
...
- [x] 11.1 Test image carousel component
  - Navigation (arrows, keyboard, thumbnails)
  - Edge cases (single image, no images)
  - Accessibility (ARIA, keyboard)

- [x] 11.2 Test property map component
  - Map rendering with valid coordinates
  - Error handling (API failure, missing coords)
  - Loading states

- [x] 11.3 Test financial metrics component
  - Currency formatting
  - Percentage formatting
  - Responsive grid layout

- [x] 11.4 Test payment history component
  - Timeline rendering
  - Status indicators
  - Empty state

- [x] 11.5 Test appraisal component
  - Value comparison calculation
  - Conditional rendering

- [x] 11.6 Test comparable properties component
  - Card rendering
  - Navigation links
  - Responsive layout
...
- [x] 11.7 Test full page load
  - Navigate from listing card to detail page
  - Verify all sections render
  - Check for console errors

- [x] 11.8 Test carousel interactions
  - Click next/previous arrows
  - Use keyboard navigation
  - Click thumbnails
  - Swipe on mobile

- [x] 11.9 Test responsive behavior
  - Desktop layout (≥1024px)
  - Tablet layout (768-1023px)
  - Mobile layout (<768px)

- [x] 11.10 Test error scenarios
...
- [x] 16.3 Security review
  - Verify input validation
  - Check authorization logic
  - Review Mapbox token restrictions

- [x] 16.4 Performance validation
  - Run final Lighthouse audit
  - Verify bundle size targets
  - Test on 3G network simulation

- [x] 16.5 Deploy to staging
  - Deploy to staging environment
  - Run smoke tests
  - Verify environment variables

- [x] 16.6 Production deployment
...
- [x] 17.1 Monitor metrics
  - Track page views and engagement
  - Monitor error rates
  - Review performance data

- [x] 17.2 Gather user feedback
  - Collect feedback from early users
  - Document improvement opportunities
  - Prioritize future iterations

- [x] 17.3 Archive proposal
